...
## Execution
To start interacting with your PDFs just run the following line. The script will give you access to a link at your localhost on port 7860 (http://127.0.0.1:7860) assuming you work with Gradio's default values. Just open your favorite browser and write that address in the URL field. Follow the instructions and enjoy!
```
python main.py
```
